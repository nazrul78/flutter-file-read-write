...
class _HomePageState extends State<HomePage> {
  ...
  Future<Directory> get getExternalVisibleDir async {
    ///storage/emulated/0/Android/data/com.example.flutter_file_read_write/files
  ...
  void _requestExternalStorageDirectory() async {
    ...
    log('${_externalDocumentsDirectory!.path}');
...
_downloadAndCreate(String url, Directory d, filename) async {
  if (await canLaunch(url)) {
    ...
    var url2 = Uri.https(url, '/books/v1/volumes', {'q': '{http}'});
